...
obj_url = f"{ALPHAVANTAGE_BASE_URL}function=DIGITAL_CURRENCY_DAILY&symbol=BTC&market=SAR&apikey={ALPHAVANTAGE_API_KEY}"
...
def main():
    ...
    print(spark_df.show())
    path = '/media/zmwaris/mydrive/data-folder/Project-1/Data-Pipeline-wtih-Kafka_Spark_Hadoop_Prefect'
